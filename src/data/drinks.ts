...
export const drinks: Drink[] = [
  // Matcha - Morning
  { category: "matcha", timeOfDay: "morning", mood: "sleepy", name: "Matcha Latte with Honey", description: "Soft, sweet boost for a gentle wake-up.", imageUrl: "https://source.unsplash.com/600x400/?matcha,latte" },
  ...
  { category: "matcha", timeOfDay: "afternoon", mood: "calm", name: "Vanilla Matcha Latte", description: "Gentle balance for your afternoon.", imageUrl: "https://source.unsplash.com/600x400/?matcha,vanilla" },
  ...
  { category: "matcha", timeOfDay: "afternoon", mood: "creative", name: "Mint Matcha", description: "Surprising mix to boost your creativity.", imageUrl: "https://source.unsplash.com/600x400/?matcha,mint" },

  // Matcha - Evening
  { category: "matcha", timeOfDay: "evening", mood: "sleepy", name: "Warm Almond Milk Matcha", description: "Relaxing and cozy drink.", imageUrl: "https://source.unsplash.com/600x400/?matcha,almond" },
  ...
  { category: "matcha", timeOfDay: "evening", mood: "creative", name: "Honey Orange Matcha", description: "Bright mix before night.", imageUrl: "https://source.unsplash.com/600x400/?matcha,orange" },
